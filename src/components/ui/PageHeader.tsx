...
export function PageHeader({
    ...
    return (
        <div className="relative mb-6">
            ...
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br from-primary-200 to-yellow-200 rounded-full opacity-60 blur-xl"></div>
            <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-gradient-to-tr from-primary-200 to-yellow-200 rounded-full opacity-40 blur-lg"></div>
            ...
            <div className="relative flex items-center gap-2 md:gap-4">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 md:gap-3">
                        <div className="w-1 md:w-1.5 h-6 md:h-8 bg-gradient-to-b from-primary-500 to-primary-600 rounded-full"></div>
