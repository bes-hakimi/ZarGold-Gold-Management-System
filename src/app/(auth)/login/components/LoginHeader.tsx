    ...
    >
      ...
      <div className="relative inline-flex items-center justify-center mb-4">
        ...
        <motion.div
          ...
          className="absolute -top-1 -right-1 bg-primary-400 rounded-full p-1 shadow-lg"
        >
          <Shield className="w-4 h-4 text-white" />
        </motion.div>
      </div>

      <h1 className="text-xl md:text-3xl font-bold bg-gradient-to-r from-primary-600 to-primary-600 bg-clip-text text-transparent">
        ورود به حساب کاربری
      </h1>
